                ...
                <%@ include file="/includes/admin-navbar.jsp" %>
                    ...
                    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-8">
                            <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Promotion</h1>
                            ...
                            <form action="${pageContext.request.contextPath}/admin/promotions" method="post"
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Discount Percentage
                                        (0-100) *</label>
                                    <input type="number" name="promotionValeur" min="0" max="100" step="0.1" required
                                        value="${promotion.promotionValeur}"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" />
