                    ...
                    <%@include file="navbar.jsp" %>
                        ...
                        <div class="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                                <div class="text-center max-w-3xl mx-auto">
                                    ...
                                    <p class="text-xl md:text-2xl text-purple-100 mb-10">Discover premium
                                        products
                                        with amazing
                                        discounts</p>
                        ...
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                            <div class="text-center mb-12">
                                ...
                                <p class="text-gray-600 text-lg">Find what you're looking for in our carefully
                                    curated
                                    categories</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="/servlet-jsp-gr3/categories"
                                            class="inline-block text-blue-600 hover:text-blue-800 font-semibold">Explore
                                            →</a>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="/servlet-jsp-gr3/categories"
                                            class="inline-block text-green-600 hover:text-green-800 font-semibold">Explore
                                            →</a>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
                            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                ...
                                <p class="text-xl mb-8 text-purple-100">Browse our collection and find your
                                    favorite
                                    products
                                </p>
                                <a href="/servlet-jsp-gr3/products"
                            ...
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                                    <div>
                                        ...
                                        <p class="text-sm">Your trusted online shopping destination for quality
                                            products at
                                            great prices.</p>
                                    </div>
                                    <div>
                                        ...
                                        <ul class="space-y-2 text-sm">
                                            <li><a href="/servlet-jsp-gr3/products"
                                                    class="hover:text-white">Products</a></li>
                                            <li><a href="/servlet-jsp-gr3/categories"
                                                    class="hover:text-white">Categories</a>
                                            </li>
                                            <li><a href="/servlet-jsp-gr3/promotions"
                                                    class="hover:text-white">Promotions</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
